...
use uefi::{proto::console::gop::GraphicsOutput, runtime, system, table::{self, cfg}};
...
pub fn get_acpi() -> boot::acpi::Acpi {
    ...
    system::with_config_table(| table | {
        for elem in table {
            if elem.guid == cfg::ConfigTableEntry::ACPI2_GUID || elem.guid == cfg::ConfigTableEntry::ACPI_GUID {
